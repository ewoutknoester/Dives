...
df1.clean.sep$Histrio <- ""
df1.clean.sep$Hiphis <- ""
df1.clean.sep$Hipkud <- ""
df1.clean.sep$Seahorse <- ""
df1.clean.sep$Pipehorse <- ""
df1.clean.sep$Ghostpipe <- ""
df1.clean.sep$Pegasus <- ""
df1.clean.sep$Leaf <- ""
df1.clean.sep$Wasp <- ""
df1.clean.sep$Rhino <- ""
df1.clean.sep$Dacori <- ""
df1.clean.sep$Stone <- ""
df1.clean.sep$Walkman <- ""
df1.clean.sep$Snakeel <- ""
df1.clean.sep$Crocodile <- ""
df1.clean.sep$Annoyingfish <- ""
## Big fish
df1.clean.sep$Epilan <- ""
df1.clean.sep$Cobia <- ""
df1.clean.sep$Napoleon <- ""
df1.clean.sep$Barracuda <- ""
df1.clean.sep$Dolphin <- ""
## Elasmo
df1.clean.sep$Torpedo <- ""
df1.clean.sep$Shark <- ""
df1.clean.sep$Guitarray <- ""
df1.clean.sep$Ray <- ""
df1.clean.sep$Eagle <- ""
## Inverts
df1.clean.sep$Harlequin <- ""
df1.clean.sep$COTS <- ""
...
df1.clean.sep$Flats <- ""
## Turtles
df1.clean.sep$Chemyd <- ""
df1.clean.sep$Ereimb <- ""
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Histrio <- ifelse(grepl('histrio',  df1.clean.sep[[obsx]]) | grepl('sargassum f',  df1.clean.sep[[obsx]]) , str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Histrio)
  df1.clean.sep[[obsx]] <- ifelse(grepl('histrio',  df1.clean.sep[[obsx]]) | grepl('sargassum f',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Hiphis <- ifelse(grepl('hip h',  df1.clean.sep[[obsx]]) | grepl('strix',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Hiphis)
  df1.clean.sep[[obsx]] <- ifelse(grepl('hip h',  df1.clean.sep[[obsx]]) | grepl('strix',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Hipkud <- ifelse(grepl('hip k',  df1.clean.sep[[obsx]]) | grepl('kud',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Hipkud)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Pipehorse <- ifelse(grepl('pipeh',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Pipehorse)
  df1.clean.sep[[obsx]] <- ifelse(grepl('pipeh',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Ghostpipe <- ifelse(grepl('ghost',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Ghostpipe)
  df1.clean.sep[[obsx]] <- ifelse(grepl('ghost',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Pegasus <- ifelse(grepl('pegasus',  df1.clean.sep[[obsx]]) | grepl('dragon',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Pegasus)
  df1.clean.sep[[obsx]] <- ifelse(grepl('pegasus',  df1.clean.sep[[obsx]]) | grepl('dragon',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Dacori <- ifelse(grepl('dac ori',  df1.clean.sep[[obsx]]) | grepl('gurnard',  df1.clean.sep[[obsx]]) | grepl('dactyloptena',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Dacori)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Stone <- ifelse(grepl('stone',  df1.clean.sep[[obsx]]) | grepl('syn ver',  df1.clean.sep[[obsx]]) | grepl('syna',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Stone)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Walkman <- ifelse(grepl('walk',  df1.clean.sep[[obsx]]) | grepl('ini fil',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Walkman)
  df1.clean.sep[[obsx]] <- ifelse(grepl('walk',  df1.clean.sep[[obsx]]) | grepl('ini fil',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Leaf <- ifelse(grepl('leaf',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Leaf)
  df1.clean.sep[[obsx]] <- ifelse(grepl('leaf',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Wasp <- ifelse(grepl('wasp',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Wasp)
  df1.clean.sep[[obsx]] <- ifelse(grepl('wasp',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Rhino <- ifelse(grepl('rhinopias',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Rhino)
  df1.clean.sep[[obsx]] <- ifelse(grepl('rhinopias',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Snakeel <- ifelse(grepl('snake',  df1.clean.sep[[obsx]]) | grepl('myr',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Snakeel)
  df1.clean.sep[[obsx]] <- ifelse(grepl('snake',  df1.clean.sep[[obsx]]) | grepl('myr',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Crocodile <- ifelse(grepl('croc',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Crocodile)
  df1.clean.sep[[obsx]] <- ifelse(grepl('croc',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Annoyingfish <- ifelse(grepl('annoy',  df1.clean.sep[[obsx]]), "1", df1.clean.sep$Annoyingfish)
  df1.clean.sep[[obsx]] <- ifelse(grepl('annoy',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

## Big fish
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Napoleon <- ifelse(grepl('napoleon',  df1.clean.sep[[obsx]]) | grepl('che und',  df1.clean.sep[[obsx]]) | grepl('undulatus',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Napoleon)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Barracuda <- ifelse(grepl('barracuda',  df1.clean.sep[[obsx]]) | grepl('sph',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Barracuda)
  df1.clean.sep[[obsx]] <- ifelse(grepl('barracuda',  df1.clean.sep[[obsx]]) | grepl('sph',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Epilan <- ifelse(grepl('epi lan',  df1.clean.sep[[obsx]]) | grepl('giant g',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Epilan)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Cobia <- ifelse(grepl('cobia',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Cobia)
  df1.clean.sep[[obsx]] <- ifelse(grepl('cobia',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

## Elasmo
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Torpedo <- ifelse(grepl('torp',  df1.clean.sep[[obsx]]) | grepl('electric',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Torpedo)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Eagle <- ifelse(grepl('eagle',  df1.clean.sep[[obsx]]) | grepl('devil',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Eagle)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Harlequin <- ifelse(grepl('harlequin',  df1.clean.sep[[obsx]]) | grepl('hym',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Harlequin)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Octo <- ifelse(grepl('octo',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Octo)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Squid <- ifelse(grepl('squid',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Squid)
  df1.clean.sep[[obsx]] <- ifelse(grepl('squid',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Nudis <- ifelse(grepl('nudi',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Nudis)
  df1.clean.sep[[obsx]] <- ifelse(grepl('nudi',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Flats <- ifelse(grepl('flat',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Flats)
...
for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Chemyd <- ifelse(grepl('che myd',  df1.clean.sep[[obsx]]) | grepl('green',  df1.clean.sep[[obsx]]) | grepl('chelonia',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Chemyd)
  df1.clean.sep[[obsx]] <- ifelse(grepl('che myd',  df1.clean.sep[[obsx]]) | grepl('green',  df1.clean.sep[[obsx]]), "", df1.clean.sep[[obsx]])
}

for (x in 1:16) {
  obsx <- paste("Obs.", x, sep="")
  df1.clean.sep$Ereimb <- ifelse(grepl('ere imb',  df1.clean.sep[[obsx]]) | grepl('hawk',  df1.clean.sep[[obsx]]) | grepl('imbricata',  df1.clean.sep[[obsx]]), str_extract(df1.clean.sep[[obsx]], "x[[:digit:]]+"), df1.clean.sep$Ereimb)
...
write_xlsx(df1.clean.sep, "Excel.xlsx")
...
ggplot(df1.clean, aes(depth, fill = depth))+
  ...
  scale_fill_manual(values = sequential_hcl(207, h = c(190, 270), c = c(55, 30), l = c(92,20)))+
...
p <- ggplot(df1.clean, aes(depth, fill = depth))+
  ...
  geom_histogram(data = df1.clean, binwidth = 2, boundary = 0, aes(depth, fill = cut(depth, 300)), show.legend = FALSE)+
  scale_fill_manual(values = sequential_hcl(207, h = c(180, 220), c = c(20, 50), l = c(97, 75)))+
